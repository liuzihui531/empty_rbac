...
class News extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('cate_id, view_count, is_hot, created', 'numerical', 'integerOnly' => true),
            ...
            array('id, title, summary, cate_id, image, content, view_count, is_hot, created', 'safe', 'on' => 'search'),
        );
    }
